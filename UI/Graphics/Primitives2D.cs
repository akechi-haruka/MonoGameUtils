...
namespace OAS.UI.Graphics
{
	...
	public static class Primitives2D
	{
		...
		public static void DrawString(this SpriteBatch spriteBatch, string text, int x, int y, Color? color = null) {
			spriteBatch.DrawString(Program.Main.Skin.DefaultFont, text, new Vector2(x, y), color.GetValueOrDefault(Program.Main.Skin.UnselectedItemColor));
		}
		...
		public static void DrawString(this SpriteBatch spriteBatch, string text, Point start, int xoff = 0, int yoff = 0, Color? color = null) {
			spriteBatch.DrawString(Program.Main.Skin.DefaultFont, text, new Vector2(start.X + xoff, start.Y + yoff), color.GetValueOrDefault(Program.Main.Skin.UnselectedItemColor));
		}
		...
		public static void DrawString(this SpriteBatch spriteBatch, SpriteFont font, string text, Point start, int xoff = 0, int yoff = 0, Color? color = null) {
			spriteBatch.DrawString(font, text, new Vector2(start.X + xoff, start.Y + yoff), color.GetValueOrDefault(Program.Main.Skin.UnselectedItemColor));
		}
		...
		public static void DrawBar(this SpriteBatch s, int x, int y, int width, int height, float filled, Color? fill = null, Color? border = null) {
			...
			s.DrawRectangle(new Rectangle(x, y, width, height), border.GetValueOrDefault(Program.Main.Skin.SystemBorderColor), 1);
		}
