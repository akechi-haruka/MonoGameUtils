...
public static class Primitives2D {
    ...
    private static readonly Dictionary<string, List<Vector2>> CIRCLE_CACHE = new Dictionary<string, List<Vector2>>();
    ...
    private static List<Vector2> CreateCircle(double radius, int sides) {
        ...
        if (CIRCLE_CACHE.ContainsKey(circleKey)) {
            return CIRCLE_CACHE[circleKey];
        }
        ...
        CIRCLE_CACHE.Add(circleKey, vectors);
    ...
    public static void DrawString(this SpriteBatch spriteBatch, string text, int x, int y, Color? color = null) {
        spriteBatch.DrawString(ExtendedGame.Instance.Skin.DefaultFont, text, new Vector2(x, y), color.GetValueOrDefault(ExtendedGame.Instance.Skin.UnselectedItemColor));
    }

    public static void DrawString(this SpriteBatch spriteBatch, string text, float x, float y, Color? color = null) {
        spriteBatch.DrawString(ExtendedGame.Instance.Skin.DefaultFont, text, new Vector2(x, y), color.GetValueOrDefault(ExtendedGame.Instance.Skin.UnselectedItemColor));
    }

    public static void DrawString(this SpriteBatch spriteBatch, string text, Point start, int xoff = 0, int yoff = 0, Color? color = null) {
        spriteBatch.DrawString(ExtendedGame.Instance.Skin.DefaultFont, text, new Vector2(start.X + xoff, start.Y + yoff), color.GetValueOrDefault(ExtendedGame.Instance.Skin.UnselectedItemColor));
    }

    public static void DrawString(this SpriteBatch spriteBatch, SpriteFont font, string text, Point start, int xoff = 0, int yoff = 0, Color? color = null) {
        spriteBatch.DrawString(font, text, new Vector2(start.X + xoff, start.Y + yoff), color.GetValueOrDefault(ExtendedGame.Instance.Skin.UnselectedItemColor));
    }

    public static void DrawString(this SpriteBatch spriteBatch, string text, Vector2 start, float xoff = 0, float yoff = 0, Color? color = null) {
        spriteBatch.DrawString(ExtendedGame.Instance.Skin.DefaultFont, text, new Vector2(start.X + xoff, start.Y + yoff), color.GetValueOrDefault(ExtendedGame.Instance.Skin.UnselectedItemColor));
    }

    public static void DrawBar(this SpriteBatch s, int x, int y, int width, int height, float filled, Color? fill = null, Color? border = null) {
        s.FillRectangle(new Rectangle(x, y, (int)(width * filled), height), fill.GetValueOrDefault(Color.Green));
        s.DrawRectangle(new Rectangle(x, y, width, height), border.GetValueOrDefault(ExtendedGame.Instance.Skin.SystemBorderColor), 1);
    }

    public static void DrawBarCentered(this SpriteBatch s, int x, int y, int width, int height, float filled, Color? fill = null, Color? border = null) {
        DrawBar(s, x - width / 2, y - height / 2, width, height, filled, fill, border);
    }
}